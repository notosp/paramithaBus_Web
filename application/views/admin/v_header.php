...
<header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg">PARAMITHA BUS</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  ...
                  <li><!-- start message -->
                    <a href="<?php echo base_url().'admin/inbox'?>">
                      <div class="pull-left">
                        <img src="<?php echo base_url().'assets/img/user_blank.png'?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        <?php echo $inbox_nama;?>
          ...
          <li>
            <a href="<?php echo base_url().''?>" target="_blank" title="Lihat Website">

...
a.penjemputan, a.jam_penjemputan, a.jumlah_bus, a.lama_sewa, b.nama,b.phone, a.nik_user, c.kode_bus, e.no_polisi, 
...
a.tgl_berangkat>=CURRENT_DATE() AND YEAR(a.tgl_berangkat)=YEAR(CURRENT_DATE()) 
...
if($stmt->num_rows > 0){
    $stmt->bind_result($id_pesan, $no_pesan, $acara, $lokasi_tujuan, $tgl_pelaksanaan, 
                       ...
                       $nama, $phone, $nik_user, $kode_bus, $no_polisi, $driver, $co_driver);
    $results = array();
    while ($stmt->fetch()) {
    $results[] = array(
        // 'id_pesan'=>$id_pesan, 
